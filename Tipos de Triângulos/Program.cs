...
Console.WriteLine("\nOs Triângulos devem ter medidas POSITIVAS, DIFERENTES DE ZERO!");
Console.WriteLine("A Soma de dois lados deve ser maior que a medida do terceiro lado!");
...
} while (lado_3 <= 0 || lado_3 == lado_1 ||  lado_3 >= (lado_2 + lado_1));
